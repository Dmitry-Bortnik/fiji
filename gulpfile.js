...
gulp.task('build-clean', function () {
    return del(paths.output.images, paths.output.fonts);
});
...
gulp.task('develop', function () {
    runSequence(
        'build-clean',
        ['sass', 'image-min', 'fonts-build', 'pug'],
        ['pug'],
        'browser-sync'
    );
});
...
gulp.task('watch', function () {
    ...
    gulp.watch(paths.input.fonts + '**/*', ['fonts-build']);
    gulp.watch(['./frontend/**/*.pug', './frontend/**/*.json'], ['pug']);
});
